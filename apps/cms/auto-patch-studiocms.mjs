...
safeReplace('node_modules/@withstudiocms/effect/dist/effect.js', (content) =>
  content.replace(
...
safeReplace('node_modules/@studiocms/markdown-remark/dist/index.js', (content) =>
  content.replace(/import\s*{[^}]+}\s*from\s*["']@astrojs\/internal-helpers["'];?/g, '')
)

// 3. Clean unused imports in studiocms handlers
const studiocmsDir = 'node_modules/studiocms/frontend/pages/studiocms_api/_handlers'
...
safeReplace('node_modules/studiocms/frontend/layouts/DashboardLayout.astro', (content) =>
  content.replace(
